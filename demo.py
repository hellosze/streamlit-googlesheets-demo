...
df = pd.read_csv("Crain's Sponsorship_House Line Item ends 11_30_2024 (refresh=true) (Oct 2, 2024 - Oct 31, 2024) - Crain's Sponsorship_House Line Item ends 11_30_2024 (refresh=true) (Oct 2, 2024 - Oct 31, 2024).csv",thousands=',')
df = df[:-1]
